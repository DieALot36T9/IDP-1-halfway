...
This is a simple online eBook reader application built with Python and vanilla JavaScript.

## Features

*   User and publisher registration and login
*   Book browsing with search and category filters
*   Subscription-based access to book categories
*   Bookmarking and reading history
*   Book details page with customer reviews
*   Publishers can upload and manage their books
*   Admin panel for managing users, publishers, and books

## Database Schema

The following is the full database schema for the application.
